...
function Footer(){
    ...
    <footer
      className="relative z-10 bg-gradiant-to-r from-white to-blue pb-10 pt-20 lg:pb-20 lg:pt-[120px] dark:bg-gray-800 dark:text-white "
    >
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              Step into style with our wide range of shoes – comfort, fashion, and unbeatable prices, all in one place!
              </p>
              <p
