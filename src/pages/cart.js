...
function Cart(){
   var total=0;
    ...
    return (<>
    <center>
   <div className="flex flex-col max-w-3xl rounded-lg p-6 space-y-4 sm:p-10 dark:bg-gray-50 dark:text-gray-800 ">
	...
	<ul className="flex flex-col divide-y dark:divide-gray-300">
		{
            products.length > 0?products.map(function (product){
                ...
                <div className="flex w-full space-x-2 sm:space-x-4">
                    <img className="flex-shrink-0 object-cover w-20 h-20 dark:border- rounded outline-none sm:w-32 sm:h-32 dark:bg-gray-500" src={`${product.image}&amp;auto=format&amp;fit=crop&amp;w=1350&amp;q=80`} alt="Product " />
                    <div className="flex flex-col justify-between w-full pb-4">
                        <div className="flex justify-between w-full pb-2 space-x-2">
                            ...
                            <div className="text-right">
                                ...
                                <p className="text-sm line-through dark:text-gray-400">{product.originalPrice}$</p>
                            </div>
                        </div>
	...
	<div className="flex justify-end space-x-4">
		<button type="button" className="px-6 py-2 border rounded-md dark:border-blue-500">Back
			<span className="sr-only sm:not-sr-only"> to shop</span>
		</button>
		<button type="button" className="px-6 py-2 border rounded-md dark:bg-blue-500 dark:text-gray-50 dark:border-blue-500">
